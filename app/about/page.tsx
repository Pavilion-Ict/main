...
const page = () => {
        ...
        <section className="mt-20">
          ...
          <div className="flex flex-col md:flex-row gap-10 mt-10">
            ...
            <div className="w-full md:w-1/3">
              ...
              />
              <h2  className="font-bold text-lg">Nearly a Decade of Delivering Excellence</h2>
              <p>
               For almost 7 years, we have consistently transformed ideas into impactful, 
               high-performing products. Our journey is defined by a commitment to quality, 
               innovation, and results—earning the trust of clients across diverse industries.
               With a multidisciplinary team and a deep understanding of both technology and market dynamics, 
               we don’t just execute projects—we deliver solutions that work, scale, and stand the test of time.
              </p>
            </div>
            <div className="w-full md:w-1/3">
              <Image
              ...
              <p>
                We operate a trusted and reliable client-centered system built on integrity, transparency 
                and consistency. Every engagement is guided by a commitment to exceptional service, 
                responsiveness, and attention to detail, ensuring a seamless and supportive experience for our clients. 
                Backed by credible expertise, we deliver high-quality, results-driven solutions 
                that are both accessible and tailored to meet the unique needs of each client.
              </p>
            </div>
          </div>
        </section>
        <section></section>
        <section className="max-w-[500px] text-center">
          <h2 className={`${futura.className} text-2xl`}>GET STARTED TODAY</h2>
          <p>
  ...
  <div className="text-center mb-8">
    ...
    <p className="text-sm text-white/70 max-w-sm mx-auto leading-relaxed">
      Our team is built to turn ideas into successful, market-ready products.
      With a strong blend of strategy, creativity, and execution, we don't just plan—we deliver.
    </p>
  </div>
